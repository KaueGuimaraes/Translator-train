LISTA = [['add', ['adicionar'], 'added', 'added'],       ['arise', ['erguer', 'levantar'], 'arose', 'arisen'],
        ...
        ['bite', ['morder', 'engolar-a-isca'], 'bit', 'bitten'],        ['bring', ['trazer', 'servir'], 'brought', ''],
        ...
        ['cast', ['arremessar', 'jogar'], 'cast', 'cast'],      ['carry', ['carregar'], 'carried', 'cerried'],
        ...
        ['fell', ['sentir', 'notar'], 'felt', 'felt'],  ['fight', ['lutar', 'brigar'], 'fought', 'fought'],
        ...
        ['feed', ['alimentar', 'nutrir'], 'fed', 'fed'],	['grow', ['crescer', 'florescer'], 'grew', 'grown'],
        ...
        ['make', ['fazer', 'produzir'], 'made', 'made'],	['may', ['poder'], 'might', ''],
        ...
        ['shoot', ['atirar', 'ferir-com-tiro'], 'shot', 'shot'],	['show', ['mostrar', 'atirar'], 'showed', 'show'],
